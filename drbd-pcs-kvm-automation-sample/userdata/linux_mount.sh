...
# https://docs.oracle.com/en-us/iaas/Content/Block/Concepts/blockvolumehigherperformance.htm#attaching
sed -i 's/^\s*node\.session\.queue_depth\s*=.*/node.session.queue_depth = 128/' /etc/iscsi/iscsid.conf
